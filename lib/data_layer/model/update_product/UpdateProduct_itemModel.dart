import 'package:e_commerce/Domain/entity/update_Product/UpdateProductItemEntity.dart';

import '../GetCartResponse/Product.dart';
...
class UpdateProductItemModel {
  ...
  UpdateProductItemModel.fromJson(dynamic json) {
    count = json['count'];
    id = json['_id'];
  ...
  Product? product;
  int? price;
UpdateProductItemModel copyWith({  int? count,
  String? id,
  Product? product,
  int? price,
}) => UpdateProductItemModel(  count: count ?? this.count,
  id: id ?? this.id,
